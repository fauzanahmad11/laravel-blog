    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <a href="{{ url('dashboard/categories/create') }}" class="btn btn-primary mb-3">New Category</a>
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>{{ $category->name }}</td>
                                <td>
                                    <a href="{{ url("dashboard/categories/$category->slug") }}/edit" class="btn-sm btn-warning"><i class="fas fa-edit"></i></a>
